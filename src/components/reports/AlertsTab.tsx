  ...
  return (
    <div className="space-y-6">
      ...
      <PageSection title="Registro Cronológico de Eventos" subtitle="Historial completo de alertas y anomalías detectadas">
        ...
        <div className="max-h-[450px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-white/10 custom-scroll">
          <div className="relative space-y-2 pl-6 before:absolute before:left-2 before:top-2 before:h-[calc(100%-1rem)] before:w-px before:bg-white/10">
            {alerts.map((alert) => (
              <div key={alert.id}
