  ...
  return (
    <div className="grid gap-4 xl:grid-cols-2">
      ...
      <PageSection
        ...
        subtitle="Configuración demostrativa"
      >
        <div className="space-y-3 text-sm text-slate-300">
          {[
            ...
            <div
              key={name}
              className="flex items-center justify-between rounded-2xl border border-white/6 bg-black/20 p-4"
            >
              <div>
              ...
              <span
                className={`rounded-full px-2.5 py-1 text-xs font-semibold ${state === "Conectado" ? "bg-emerald-500/10 text-emerald-300" : "bg-amber-500/10 text-amber-300"}`}
              >
                {state}
              </span>
            </div>
      ...
      <PageSection
        ...
        subtitle="Persistidos en localStorage"
      >
